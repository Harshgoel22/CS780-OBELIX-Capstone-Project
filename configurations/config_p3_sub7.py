...
config = {
    ...
    'eps_decay_strategy': [
        ...
        ("exponential", {'s': 400, 'e': 999, 'ival': 0.35, 'fval': 0.01})
    ],
    'device': device,
    'delta': 0.99,
    'tau': 0.005,
    ...
    'f_hDim': [324, 256],
    'lstm_hDim': 128,
    'model_path': '../model_weights/model_weights_phase3_sub7',
    'loss_fn': 'HuberLoss',
    'seq_len': 35,
    'burn_in': 10,
    'minSamples': 20, # represents to collection of one whole sequqnce of experiences
    'for_hDim': [224, 128],
    'inv_hDim': [224, 128],
    'alpha_f': 0.12,
    'beta_i': 0.15,
