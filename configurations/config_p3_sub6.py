...
config = {
    ...
    'epsilon': 0.98,
    'eps_decay_strategy': [
        ("linear", {'s': 0, 'e': 399, 'ival': 1.0, 'fval': 0.35}),
        ("exponential", {'s': 400, 'e': 799, 'ival': 0.35, 'fval': 0.01})
    ],
    'device': device,
    'delta': 0.99,
    'tau': 0.005,
    ...
    'f_hDim': [324, 256],
    'lstm_hDim': 128,
    # 'model_path': '../model_weights/model_weights_phase3_sub6',
    'model_path': '../model_weights/model_weights_eval_p3_sub6_updated',
    'loss_fn': 'HuberLoss',
    'seq_len': 30,
    'burn_in': 10,
