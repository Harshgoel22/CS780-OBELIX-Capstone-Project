    ...
    def trainNetwork(self, batch_experiences):
        ...
        with torch.no_grad():
            ...
            for t in reversed(range(T)):
                ...
                delta = rs[:, t] + self.gamma * vt_1.squeeze(1) * done - vt.squeeze(1)
        ...
        for t in range(self.burn_in, T):
            ...
            newvalue = self.model.value_head(z)
            value_loss = F.mse_loss(newvalue.squeeze(1), returns[:, t], reduction='none')
